...
//  H = 1*2^(h-1) + 2*2^(h-2) + ............. + 1*h . 


//  SO , while we finding the Hight we get 2^(h+1) - h -2 = n where n is the number of nodes in the Tree .

//  So taking log both the side and finaly TC = (n).




// Same for min Heap just One Operation change .
